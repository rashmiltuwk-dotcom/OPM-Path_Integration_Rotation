...
S.condLabels      = {'CloseEyes', 'OpenEyes',  'PhysicallyWalk', 'EncodingRotate', 'ResponseRotate', 'ImagineWalk', 'MasterSync'};
S.thresh          = THRESH;
...
S.condLabels      = {'CloseEyes', 'OpenEyes',  'PhysicallyWalk', 'EncodingRotate', 'ResponseRotate', 'ImagineWalk'};
S.thresh          = THRESH;
...
for i = 1:size(valid_events, 1)
    ...
    onset_realigned = onset - t_zero;
    
    % Build trl with realigned samples
    trl(end+1, :)          = [onset_realigned + pre_trig_samp, ...
                               onset_realigned + post_trig_samp, ...
                               pre_trig_samp];
